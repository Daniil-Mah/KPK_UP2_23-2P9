...
|---|---|---|---|---|---|
| full_name | Фамилия | Обязательно | Строка |  |  |
...
| Параметр | Пояснение | Обязательность | Тип | Ограничение | Значение по умолчанию |
|---|---|---|---|---|---|
| full_name | Фамилия | Не обязательно | Строка |  |  |
...
Настройки уведомлений по ID определяют измененные (отличающиеся от исходных) параметры и их значения персонализации (состяний) уведомлений для каждого конкретного пользователя.
