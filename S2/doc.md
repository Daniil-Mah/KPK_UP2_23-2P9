...
| telephone | Номер телефона | Обязательно | Строка | Формат записи:'+7(000)000-00-00', должно быть уникальным. |  |
...
| telephone | Номер телефона | Не обязательно | Строка | Формат записи:'+7(000)000-00-00', должно быть уникальным. |
